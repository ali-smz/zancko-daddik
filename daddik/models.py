...
class User(AbstractBaseUser):
    ...
    profilePicture = models.FileField(upload_to='media/images', blank=True)
    ...
    document = models.FileField(upload_to='media/pdfs', blank=True)
    officialNewspaper = models.FileField(upload_to='media/pdfs', blank=True)
    ...
    introductionLetter = models.FileField(upload_to='media/pdfs', blank=True)
