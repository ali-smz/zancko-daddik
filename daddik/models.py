...
class User(AbstractBaseUser):
    ...
    document = models.FileField(upload_to='usr/src/app/uploads/pdfs', blank=True)
    officialNewspaper = models.FileField(upload_to='usr/src/app/uploads/pdfs', blank=True)
    ...
    introductionLetter = models.FileField(upload_to='usr/src/app/uploads/pdfs', blank=True)
